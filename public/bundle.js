	...
	var App = React.createClass({displayName: "App",
		...
		render: function(){
			var listComponents = this.state.lists.map(function(list, index){
				return (
					React.createElement(ListContainer, {title: list.name, key: index, remove: this.removeList, index: index, bgColor: list.bgColor})
				)
			}.bind(this))
			return (
			...
			return (			
					React.createElement("div", {className: "col-sm-6 col-md-offset-3"}, 
						React.createElement("div", {className: "col-sm-12", style: styles.container}, 
							React.createElement("span", {className: "glyphicon glyphicon-remove", style: styles.removeList, onClick: this.props.remove.bind(null, this.props.index)}), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(3);
	var SelectColor = __webpack_require__(6);
		...
		render: function() {
			return (
				React.createElement("div", null, 
					...
					React.createElement(SelectColor, {setColor: this.setListColor})
				)
			)
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddItem = React.createClass({displayName: "AddItem",
		...
		render: function() {
			return (
				React.createElement("div", null, 
					React.createElement("input", {type: "text", className: "form-control", value: this.state.newItem, onChange: this.handleChange, onKeyDown: this.handleSubmit})
				)
			)
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SelectColor = React.createClass({displayName: "SelectColor",
		getInitialState: function(){
			return {
				colors: [
					'rgb(255, 172, 236)',
			...
			var boxes = this.state.colors.map(function(color, index){
				return (
					React.createElement("div", {
						...
						key: index, 
						onClick: this.changeColor.bind(null, index)})
				)
			}.bind(this))
